...
<div class="getbwp-front-cont getbw-drop-down-cont" id="getbwp-front-cont">  


<?php if(isset($display_steps) && $display_steps == 'yes' && !isset($_GET['getbwp_order_key'])){?>
...
<div id="getbwp-spinner" class="getbwp-spinner" style="display:">
		 ...
		 <div class="getbwp-book-info-text getbwp-book-info-text-reduced" id="getbwp-steps-cont-res-selectors" > 
		 ...
		 <div class="getbwp-book-info-text getbwp-book-info-text-reduced" id="getbwp-steps-cont-res-selectors-staff" > 
              
		 </div>

		 <div class="getbwp-book-info-text getbwp-book-info-text-reduced" id="getbwp-steps-cont-res-selectors-weekdays" > 

		 <?php echo $getbookingwp->service->get_week_days_to_check() ?>
		 ...
		 if(!isset($_GET['getbwp_order_key'])){ ?>

			<div class="getbwp-book-info-text getbwp-book-info-text-reduced-options" id="getbwp-steps-cont-res-selectors-button" > 

				<button id="getbwp-btn-make-search" class="getbwp-button-submit getbwp-button-submit-search"> <?php _e('Check Availability','get-bookings-wp')?></button>
...
<input type="hidden"  id="booking_template" name="booking_template" value="<?php echo esc_attr( $template)?>" />
...
<?php if($auto_display_staff=='no' && $auto_display_slots=='no' && !$payment_url){ ?>
	...
	getbwp_reload_serv_of_locations_dropdown();			  
