...
<div class="getbwp-front-cont-side-bar" >  

         <div class="getbwp-front-steps-bar  getbwp-front-steps-bar-left  ui-datepicker-wrapper" id="getbwp-front-steps-bar">
          
            <div id="nuv-fron-date-picker-d" class="nuv-fron-date-picker-d"></div>
...
<div class="getbwp-front-cont-rigth-bar" > 
...
<input type="hidden"  id="template" name="template" value="<?php echo esc_attr( $template)?>" />
